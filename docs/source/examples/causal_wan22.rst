...
FastVideo-style Wan2.2 causal T2V, driven by the unified
``flashdreams-run`` CLI under the slug ``causal-wan22-fastvideo-t2v``.
Reference: `FastVideo basic_self_forcing_causal_wan2_2_i2v.py
