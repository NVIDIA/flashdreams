...
``configs/omnidreams_demo_replay_benchmarks.json`` contains a manual comparison
between the legacy Omnidreams single-view runner and the experimental shared
demo replay path:
...
scoring until those output layouts are aligned.
