...
"""SlangPy UI thread for FlashDreams applications."""
...
class SlangPyUIThread(UIThread[_StateT], ABC, Generic[_StateT]):
    ...
    def __init__(
        ...
        *,
        ...
        """Configure a SlangPy UI thread without creating GPU resources.
    ...
    def step_ui(self, step_index: int, events: UserInputEvents) -> StepResult:
        """Render the UI over the optional back-buffer returned by :meth:`draw_ui`."""
