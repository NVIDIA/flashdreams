...
from waypoint.runner import WaypointRunnerConfig
...
RUNNER_WAYPOINT_1_5 = WaypointRunnerConfig(
    runner_name=PIPELINE_WAYPOINT_1_5.name,
    description="Waypoint 1.5 1B controlled image-established rollout.",
    pipeline=PIPELINE_WAYPOINT_1_5,
)
"""Default command-line runner for the published Waypoint 1.5 checkpoint."""

RUNNER_CONFIGS: dict[str, RunnerConfig] = {
    cfg.runner_name: cfg for cfg in (RUNNER_WAYPOINT_1_5,)
}
"""Waypoint runners keyed by their ``flashdreams-run`` subcommand."""
