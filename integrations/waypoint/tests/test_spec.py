...
def test_runner_registration_uses_the_image_established_pipeline() -> None:
    """The CLI configuration points to the model-specific seed-state pipeline."""
    assert isinstance(PIPELINE_WAYPOINT_1_5, WaypointInferencePipelineConfig)
    assert RUNNER_WAYPOINT_1_5.runner_name == PIPELINE_WAYPOINT_1_5.name
    assert RUNNER_WAYPOINT_1_5.pipeline is PIPELINE_WAYPOINT_1_5
