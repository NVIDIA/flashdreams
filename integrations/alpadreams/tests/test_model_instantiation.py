...
"""Alpadreams-specific model instantiation tests.

Split out from ``flashdreams/tests/test_model_instantiation.py`` when
Alpadreams moved out of the in-tree recipe set; the wan/cosmos/umt5
...
class TestVideoVAE:
    """Tests for alpadreams-shipped video VAE models."""
