...
Usage:
    ...
    .. code-block:: bash
        ...
        uv run --package flashdreams-lingbot2 python integrations/lingbot2/lingbot2/trajectory_viz.py \
            --example_idx 0 \
            --output_path outputs/lingbot2-world-traj-00.mp4
    ...
    .. code-block:: bash
        ...
        uv run --package flashdreams-lingbot2 python integrations/lingbot2/lingbot2/trajectory_viz.py \
            --example_idx 5 \
            --output_path outputs/lingbot2-world-traj-05.mp4
    ...
    .. code-block:: bash
        ...
        uv run --package flashdreams-lingbot2 python integrations/lingbot2/lingbot2/trajectory_viz.py \
            --example_idx 0 \
            --stride 2 \
            --output_path outputs/lingbot2-world-traj-00-fast.mp4
"""
...
DEFAULT_EXAMPLE_DATA_ROOT = REPO_ROOT / "assets/example_data/lingbot_world_v2"
DEFAULT_OUTPUT_PATH = REPO_ROOT / "outputs/lingbot2_camera_trajectory.mp4"
AVAILABLE_EXAMPLE_IDXS = (0, 1, 2, 5)
DEFAULT_OUTPUT_FPS = 16
"""Default trajectory video FPS, aligned with ``Lingbot2WorldRunnerConfig.fps``."""
LINE_THICKNESS = 6
...
def _parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=(
            ...
            "from Lingbot2 example poses.npy."
        )
    )
    parser.add_argument(
        "--example_idx",
...
def main() -> None:
    """Render and save a trajectory MP4 from Lingbot2 ``poses.npy``."""
    args = _parse_args()
