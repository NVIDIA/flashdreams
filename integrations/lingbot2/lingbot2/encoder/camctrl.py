...
"""I2V + Plücker camera-control encoder for Lingbot2 World."""
...
@dataclass(kw_only=True)
class Lingbot2I2VCtrlEncoderConfig(WanI2VCtrlEncoderConfig):
...
class I2VCamCtrlEncoderConfig(EncoderConfig):
    ...
    i2v: Lingbot2I2VCtrlEncoderConfig = field(
        default_factory=Lingbot2I2VCtrlEncoderConfig
    )
...
class I2VCamCtrlEncoder(StreamingVideoEncoder[I2VCamCtrlEncoderCache]):
    ...
    by 8x8 into channel dim — equivalent to the upstream Lingbot2 World pipeline
