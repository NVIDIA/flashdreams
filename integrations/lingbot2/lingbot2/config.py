...
"""Configs for the LingBot-World v2 streaming camera-control I2V model."""
...
from lingbot2.encoder.camctrl import (
    I2VCamCtrlEncoderConfig,
    Lingbot2I2VCtrlEncoderConfig,
)
from lingbot2.pipeline import Lingbot2WorldInferencePipelineConfig
from lingbot2.runner import Lingbot2WorldRunnerConfig
from lingbot2.transformer import Lingbot2WorldTransformerConfig
from lingbot2.transformer.impl.network import Lingbot2WorldDiTNetwork14BConfig
...
# Official LingBot-World v2 14B causal-fast pipeline config.
PIPELINE_LINGBOT_WORLD_V2_14B_CAUSAL_FAST = Lingbot2WorldInferencePipelineConfig(
    name="lingbot-world-v2-14b-causal-fast",
    enable_sync_and_profile=True,
    encoder=I2VCamCtrlEncoderConfig(
        i2v=Lingbot2I2VCtrlEncoderConfig(
    ...
    diffusion_model=DiffusionModelConfig(
        seed=42,
        transformer=Lingbot2WorldTransformerConfig(
            network=Lingbot2WorldDiTNetwork14BConfig(
            ...
            len_t=3,
            # CFG off by default to match the upstream LingBot-World v2 checkpoint.
            guidance_scale=1.0,
            window_size_t=63,
            sink_size_t=0,
        ...
        scheduler=FlowMatchSchedulerConfig(
            ...
            # LingBot-World v2 14B causal-fast checkpoint).
...
RUNNER_LINGBOT_WORLD_V2_14B_CAUSAL_FAST = Lingbot2WorldRunnerConfig(
    runner_name=PIPELINE_LINGBOT_WORLD_V2_14B_CAUSAL_FAST.name,
    description="LingBot-World v2 14B causal-fast streaming camera-control I2V (Wan VAE decoder, 4-step).",
...
PIPELINE_CONFIGS: dict[str, Lingbot2WorldInferencePipelineConfig] = {
    cfg.name: cfg
    for cfg in (
        PIPELINE_LINGBOT_WORLD_V2_14B_CAUSAL_FAST,
...
"""All shipped LingBot-World v2 pipeline configs, keyed by ``name``."""
