...
"""Context-parallel patchify smoke test for the Lingbot2 World transformer."""

import pytest
import torch
from lingbot2.encoder.camctrl import I2VCamCtrlEmbeddings
from lingbot2.transformer import (
    Lingbot2WorldTransformer,
    Lingbot2WorldTransformerConfig,
)
from lingbot2.transformer.impl.network import (
...
def test_lingbot2_patchify_marks_i2v_and_plucker_as_patchified() -> None:
    transformer = Lingbot2WorldTransformer(
        Lingbot2WorldTransformerConfig(
            network=Lingbot2WorldDiTNetworkConfig(
                dim=64,
                ffn_dim=128,
                num_heads=4,
                num_layers=1,
