...
class FakeSessionManager:
    def __init__(self) -> None:
        ...
        self.pending_inputs: list[Lingbot2SessionInput] = []
        self.active = False
        ...
        self.first_frame = Lingbot2ImagePayload(
    ...
    async def create_answer(self, *, offer_sdp: str, offer_type: str) -> dict[str, str]:
        ...
        if self.raise_busy:
            raise SessionBusyError("A Lingbot2 session is already active.")
        self.active = True
...
async def test_request_session_serves_html() -> None:
    ...
    try:
        ...
        assert "Lingbot2 WebRTC Viewer" in body
    finally:
        await client.close()
