...
from onmidreams.config import (
    ONMIDREAMS_CONFIGS as CONFIGS,
)
from onmidreams.transformer import CosmosTransformerConfig
from onmidreams.transformer.impl.network import CosmosDiTNetwork
...
def main() -> None:
    ...
    assert isinstance(transformer_config, CosmosTransformerConfig), (
        "convert_i4_dcp2pt requires an Onmidreams Cosmos transformer config; "
