...
import numpy as np
import pytest
from onmidreams.grpc.protos import (
    camera_pb2,
    common_pb2,
    video_model_pb2,
...
def test_grpc_server_start_render_close_roundtrip(
    ...
    server_cmd = [
        sys.executable,
        "-m",
        "integrations.onmidreams.onmidreams.grpc.server",
        "--host",
        "127.0.0.1",
        "--port",
        str(port),
        ...
        "onmidreams-sv-2steps-chunk2-loc6-lightvae-lighttae",
    ]
    ...
    pythonpath_entries = [
        ...
        str(REPO_ROOT / "integrations" / "onmidreams"),
        str(REPO_ROOT / "integrations" / "onmidreams" / "ludus-renderer"),
    ]
