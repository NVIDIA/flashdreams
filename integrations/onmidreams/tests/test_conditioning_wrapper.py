...
"""Unit tests for the Onmidreams conditioning wrapper.
...
def _make_wrapper(
    *,
    ...
    wrapper = OnmidreamsConditioningWrapper.__new__(OnmidreamsConditioningWrapper)
...
def test_start_continue_and_finalize_flow() -> None:
    ...
    assert isinstance(start_output.state, OnmidreamsConditioningState)
