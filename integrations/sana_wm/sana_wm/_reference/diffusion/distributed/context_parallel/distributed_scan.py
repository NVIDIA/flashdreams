...
def _get_local_scan_cls(device_is_cuda: bool) -> type:
    ...
    if backend == "triton":
        from sana_wm._reference.diffusion.model.ops.frame_gdn.scan_triton import FrameGDNScan
...
from sana_wm._reference.diffusion.distributed.context_parallel.halo_exchange import _to_global_rank
