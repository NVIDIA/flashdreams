...
def triton_chunk_sana_gdn(
    ...
    **ignored** -- the Triton scan processes all T frames in a single fused
    ...
    from sana_wm._reference.diffusion.model.ops.frame_gdn.scan_triton import FrameGDNScanAndProject
...
def triton_recurrent_sana_gdn(
    ...
    from sana_wm._reference.diffusion.model.ops.frame_gdn.fused_recurrent_triton import (
