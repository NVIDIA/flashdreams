...
from sana_wm._reference.diffusion.distributed.context_parallel.config import cp_enabled
from sana_wm._reference.diffusion.model.nets.sana_camctrl_blocks import (
    _maybe_drop_cam_branch,
    _prepare_ray_apply_fns,
)
from sana_wm._reference.diffusion.model.nets.sana_gdn_blocks import BidirectionalGDN
from sana_wm._reference.diffusion.model.nets.sana_gdn_camctrl_blocks import (
    BidirectionalGDNUCPESinglePathLiteLA,
)
from sana_wm._reference.diffusion.model.ops.fused_cam_gdn import (
    _invert_SE3,
    _prepare_ucpe_rope_tables,
    _process_camera_conditions_raymats_only,
    cam_prep_func,
)
from sana_wm._reference.diffusion.model.ops.fused_gdn import (
    fused_bigdn_func,
    fused_qk_inv_rms,
    prepare_rope_tables,
)
from sana_wm._reference.diffusion.model.ops.fused_gdn_chunkwise import cam_scan_bidi_chunkwise
from sana_wm._reference.diffusion.model.registry import ATTENTION_BLOCKS
from sana_wm._reference.diffusion.utils.chunk_utils import (
...
class BidirectionalGDNTriton(BidirectionalGDN):
    ...
    def _forward_cp_scan_triton_ag(
        ...
        **kwargs: object,
        ...
        from sana_wm._reference.diffusion.distributed.context_parallel.config import get_cp_group
        from sana_wm._reference.diffusion.distributed.context_parallel.distributed_scan import cp_frame_gdn_scan
        from sana_wm._reference.diffusion.distributed.context_parallel.halo_exchange import cp_halo_exchange
        from sana_wm._reference.diffusion.model.ops.frame_gdn.api import (
            _build_transition_matrices,
            compiled_gdn_output_projection,
        )
        from sana_wm._reference.diffusion.model.ops.fused_gdn_cp import cp_fused_gdn_chunkwise_raw_autograd
    ...
    def forward(
        ...
        **kwargs: object,
        ...
        if cp_enabled():
            ...
            from sana_wm._reference.diffusion.distributed.context_parallel.config import (
...
class BidirectionalGDNUCPESinglePathLiteLABothTriton(BidirectionalGDNUCPESinglePathLiteLATriton):
    ...
    def _forward_cam_branch_cp_triton_ag(
        ...
        * Backward branch uses an eager ``_cp_flip_and_shift`` +
        ...
        from sana_wm._reference.diffusion.distributed.context_parallel.distributed_scan import cp_frame_gdn_scan
        from sana_wm._reference.diffusion.distributed.context_parallel.halo_exchange import cp_halo_exchange
        from sana_wm._reference.diffusion.model.ops.frame_gdn.api import _build_transition_matrices
        from sana_wm._reference.diffusion.model.ops.fused_gdn_cp import cp_fused_cam_gdn_num_autograd
