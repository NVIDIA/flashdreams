...
from sana_wm._reference.diffusion.model.builder import MODELS
from sana_wm._reference.diffusion.model.nets.basic_modules import GLUMBConv, GLUMBConvTemp, Mlp
from sana_wm._reference.diffusion.model.nets.sana_blocks import (
    CaptionEmbedder,
...
from sana_wm._reference.diffusion.model.nets.sana_multi_scale import Sana, get_2d_sincos_pos_embed
from sana_wm._reference.diffusion.model.registry import ATTENTION_BLOCKS, FFN_BLOCKS
from sana_wm._reference.diffusion.model.utils import auto_grad_checkpoint, create_block_mask_cached, generate_temporal_head_mask_mod
from sana_wm._reference.diffusion.model.wan.model import BlockHook
from sana_wm._reference.diffusion.utils.dist_utils import get_rank
from sana_wm._reference.diffusion.utils.import_utils import is_xformers_available
...
class SanaMSVideoCamCtrl(Sana):
    ...
    def _compute_rope_with_cp(self, device: torch.device, h: int, w: int) -> torch.Tensor:
        ...
        """
        from sana_wm._reference.diffusion.distributed.context_parallel.config import cp_enabled, get_cp_group
    ...
    def create_diagonal_mask(self, N_pad, N, num_frames, block_size=1, mask_type="nlogn"):
        from sana_wm._reference.tools.attn_mask.gen_nlogn_mask import (
