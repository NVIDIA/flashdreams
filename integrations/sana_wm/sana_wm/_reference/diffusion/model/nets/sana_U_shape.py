...
from sana_wm._reference.diffusion.model.nets.sana import Sana, get_2d_sincos_pos_embed
...
if is_triton_module_available():
    from sana_wm._reference.diffusion.model.nets.fastlinear.modules import TritonLiteMLA
