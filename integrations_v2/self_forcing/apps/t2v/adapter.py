...
"""Self-Forcing configuration adapter for the shared T2V application."""
...
def load_config() -> T2VApplicationDefaults:
    """Load Self-Forcing defaults for the shared T2V application."""
...
def create_app(
    ...
    *,
    ...
    """Create the shared T2V application with Self-Forcing configured.
