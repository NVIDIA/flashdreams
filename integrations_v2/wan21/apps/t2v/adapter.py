...
"""Wan 2.1 configuration adapter for the shared T2V application."""
...
def load_config() -> T2VApplicationDefaults:
    """Load Wan 2.1 defaults for the shared T2V application."""
...
def create_app(
    ...
    *,
    ...
    """Create the shared T2V application with Wan 2.1 configured.
