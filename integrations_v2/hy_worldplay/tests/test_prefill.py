...
def test_memory_kv_cache_defaults_to_empty() -> None:
    ...
    """
    from hy_worldplay.impl._camera import HyWorldPlayMemoryKVCache
...
def test_transformer_cache_history_defaults_to_empty() -> None:
    ...
    """
    from hy_worldplay.impl._action import HyWorldPlayWan21TransformerCache
...
def test_append_clean_latent_grows_history_and_detaches() -> None:
    ...
    """
    from hy_worldplay.impl._action import HyWorldPlayWan21Transformer
...
def test_ctrl_rollout_fields_default_to_none() -> None:
    ...
    treats as unchanged.
    """
    from hy_worldplay.impl._action import HyWorldPlayCtrl
...
def test_ctrl_rollout_fields_survive_patchify_rebuild() -> None:
    ...
    """
    from hy_worldplay.impl._action import HyWorldPlayCtrl, HyWorldPlayWan21Transformer
