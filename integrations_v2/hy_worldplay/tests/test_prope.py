...
Verifies :mod:`hy_worldplay.impl._prope` against a numpy reference
...
def test_prope_qkv_matches_numpy_reference_with_intrinsics() -> None:
    ...
    from hy_worldplay.impl._prope import prope_qkv
...
def test_build_prope_apply_fns_can_be_called_repeatedly() -> None:
    ...
    from hy_worldplay.impl._prope import build_prope_apply_fns
