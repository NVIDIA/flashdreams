...
# env-var contract as
# ``integrations_v2/hy_worldplay/tests/parity_check/run.sh``.
#
# Usage:
#   ./integrations_v2/hy_worldplay/run-docker.sh
#
...
#       ./integrations_v2/hy_worldplay/run-docker.sh
#
#   NUM_GPU=4 ./integrations_v2/hy_worldplay/run-docker.sh   # multi-GPU via torchrun
#
...
PARITY_REL="integrations_v2/hy_worldplay/tests/parity_check"
...
if [[ ! -d "${REPO_HOST_PATH}/integrations_v2/hy_worldplay" ]]; then
...
PARITY=integrations_v2/hy_worldplay/tests/parity_check
