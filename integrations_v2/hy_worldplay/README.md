...
[`integrations_v2/self_forcing`](../self_forcing/README.md) pattern.
...
( cd integrations_v2/hy_worldplay/tests/parity_check && uv sync )
```
...
```bash
uv run --extra dev pytest integrations_v2/hy_worldplay/tests/test_smoke.py
```
...
```bash
bash integrations_v2/hy_worldplay/tests/parity_check/run.sh
```
...
bash integrations_v2/hy_worldplay/tests/parity_check/bench.sh
```
...
bash integrations_v2/hy_worldplay/tests/parity_check/bench_batch.sh
```
