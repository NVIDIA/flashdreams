...
"""Cosmos Predict2 configuration adapter for the shared T2V application."""
...
def load_config() -> T2VApplicationDefaults:
    """Load Cosmos Predict2 defaults for the shared T2V application."""
...
def create_app(
    ...
    *,
    ...
    """Create the shared T2V application with Cosmos Predict2 configured.
