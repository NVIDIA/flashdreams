...
temporary directory you can reach, then play the file::
    ...
    T2V_COSMOS_PREDICT2_REAL_MODEL_RUN=1 uv run --no-sync pytest \
        integrations_v2/cosmos_predict2/tests -m ci_gpu -s --basetemp="$HOME/t2v-out"
...
import pytest
from cosmos_predict2.apps.t2v.adapter import CosmosPredict2T2VApplication
...
_PROMPT = "Robotic welding in a high-definition industrial setting."
