...
def _apply_t2v_compile_override(pipeline_config: object, enabled: bool) -> object:
...
T2V_APPLICATION_DEFAULTS = T2VApplicationDefaults(
    ...
    pixel_height=480,
    pixel_width=832,
    prompt="A stylish woman walks through a neon-lit Tokyo street at night.",
    fps=16,
)
"""Defaults exposed to the shared T2V application."""

T2V_APPLICATION_HOOKS = T2VIntegrationHooks(
    apply_compile_override=_apply_t2v_compile_override
)
"""CausalWan hooks exposed to the shared T2V application."""
