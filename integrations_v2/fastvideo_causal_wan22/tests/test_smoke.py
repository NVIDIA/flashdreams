...
"""CPU configuration checks for the fastvideo_causal_wan22 v2 application binding."""
...
from fastvideo_causal_wan22.config import T2V_APPLICATION_DEFAULTS
...
def test_application_entry_point_uses_the_nested_adapter() -> None:
    ...
    assert entries == {"t2v-fastvideo-causal-wan22": "fastvideo_causal_wan22.apps.t2v.adapter:create_app"}
