...
"""CausalWan configuration adapter for the shared T2V application."""
...
def load_config() -> T2VApplicationDefaults:
    """Load CausalWan defaults for the shared T2V application."""
...
def create_app(
    ...
    *,
    ...
    """Create the shared T2V application with CausalWan configured.
