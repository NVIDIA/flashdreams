...
temporary directory you can reach, then play the file::
    ...
    T2V_CAUSAL_FORCING_REAL_MODEL_RUN=1 uv run --no-sync pytest \
        integrations_v2/causal_forcing/tests -m ci_gpu -s --basetemp="$HOME/t2v-out"
...
import pytest
from causal_forcing.apps.t2v.adapter import CausalForcingT2VApplication
...
_PROMPT = "A cinematic closeup of a reindeer in a snowy forest at sunset."
