...
``integrations_v2/flashvsr/tests/parity_check/test_tcdecoder_parity.py``.
...
class IdentityConv2d(nn.Conv2d):
    ...
    test under ``integrations_v2/flashvsr/tests/parity_check/`` agrees
    byte-for-byte.
    """
...
def _apply_identity_deepen(
    ...
    ``integrations_v2/flashvsr/tests/parity_check/`` loads upstream's file
