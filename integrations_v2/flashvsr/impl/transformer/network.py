...
inference cache lives in :mod:`flashvsr.impl.transformer`
(``__init__.py``).

``integrations_v2/flashvsr/tests/parity_check/test_dit_parity.py`` asserts
...
def _get_block_sparse_attn_triton_func():
    ...
    from flashvsr.impl.transformer.triton_sparse_attn import block_sparse_attn_func
...
# ``integrations_v2/flashvsr/tests/parity_check/test_dit_parity.py`` compares
