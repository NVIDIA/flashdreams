...
Drives :class:`flashvsr.impl.pipeline.FlashVSRPipeline` once per
...
Usage (from repo root):
    ...
    uv run --no-sync python -m flashvsr.impl.grpc.uplift_server --viewer_port 8080
"""
...
from flashvsr.impl.grpc.streaming_view import (
