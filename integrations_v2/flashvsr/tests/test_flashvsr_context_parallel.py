...
.. code-block:: bash
    ...
    uv run --extra dev pytest \
        integrations_v2/flashvsr/tests/test_flashvsr_context_parallel.py::test_flashvsr_full_attention_cp_equivalence -v
...
from flashvsr.impl.transformer import FlashVSRTransformer, FlashVSRTransformerConfig
from flashvsr.impl.transformer.network import FlashVSRBlock, FlashVSRDiTNetworkConfig
