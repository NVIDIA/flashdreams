...
candidate is the live :class:`flashvsr.impl.transformer.FlashVSRTransformer`.
...
def _build_models(
    *,
    ...
    equivalent rearrange via ``flashvsr.impl.transformer.network.state_dict_transform``,
