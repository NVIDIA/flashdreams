...
from omnidreams_game_engine.input.backend import InputBackend, SampledInput
...
class KeyboardState:
    ...
    Implements :class:`~omnidreams_game_engine.runtime.runtime_controls.RuntimeControls`
