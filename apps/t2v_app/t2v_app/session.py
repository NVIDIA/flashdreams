...
class T2VSession(Session):
    ...
    def __init__(
        ...
        *,
        ...
        pixel_height = scenario[FIELD_PIXEL_HEIGHT]
        pixel_width = scenario[FIELD_PIXEL_WIDTH]
        ...
        self._prompt = scenario[FIELD_PROMPT]
...
def _session_scenario(
    ...
    for name in (FIELD_PIXEL_HEIGHT, FIELD_PIXEL_WIDTH):
        value = values[name]
...
__all__ = ["T2VSession", "T2VSessionDefaults"]
