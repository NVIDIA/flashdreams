...
from hdmap2v.interactive_drive.input.backend import InputBackend, SampledInput
...
class KeyboardState:
    ...
    Implements :class:`~hdmap2v.interactive_drive.runtime.runtime_controls.RuntimeControls`
