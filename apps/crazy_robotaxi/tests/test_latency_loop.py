...
import numpy as np
import omnidreams_game_engine.runtime.loop as loop_module
import pytest
from crazy_robotaxi.game import (
    TaxiGameConfig,
    TaxiGameController,
)
from omnidreams_game_engine._pipeline_fakes import (
    FakeVideoModelBackend,
    make_trajectory,
    minimal_scene,
)
from omnidreams_game_engine.application import ApplicationChunkUpdate
from omnidreams_game_engine.input.backend import SampledInput
from omnidreams_game_engine.math3d import rig_pose_from_vehicle_state
from omnidreams_game_engine.runtime.loop import (
    LoopConfig,
