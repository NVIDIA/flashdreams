...
Covers ``omnidreams_game_engine.ply_io``,
``omnidreams_game_engine.simulation.ground_snap.GroundSnapper``, and the
integration into
``omnidreams_game_engine.simulation.ego_vehicle_kinematics.sample_chunk_trajectory``.
"""
...
import numpy as np
import omnidreams_game_engine.simulation.ego_vehicle_kinematics as kinematics_module
import pytest
...
from omnidreams_game_engine.ply_io import load_mesh_vf, save_mesh_vf
